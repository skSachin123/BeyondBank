...
const Main = () => {
  ...
  let [welcomeMessage, setWelcomeMessage] = useState(
    JSON.parse(localStorage.getItem("welcomeMessage"))
  );
  const [show, setShow] = useState(false);
  const handleClose = () => {
    localStorage.setItem("welcomeMessage", JSON.stringify(false));
    setWelcomeMessage(JSON.parse(localStorage.getItem("welcomeMessage")));
  };
